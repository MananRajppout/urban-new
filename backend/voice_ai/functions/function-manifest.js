...
const tools = [
  {
    ...
    function: {
        name: 'transferCall',
        say: 'Let me connect you with someone who can help you better. One moment please.',
        description: 'Strictly call this function once you are asked to transer the call and after and inform the caller you are transferring the call in one short line and immmidetaley stop responding to any query strictly.',
        parameters: {
            type: 'object',
            properties: {
                callSid: {
                ...
                transferNumber: {
                    type: 'string',
                    description: 'The phone number to which the call will be transferred.'
                }
            },
            required: ['callSid', 'transferNumber']
        },
        returns: {
            type: 'object',
            properties: {
                status: {
                    type: 'string',
                    description: 'Indicates whether the call was successfully transferred.'
                }
            }
        }
    }
  },
    {
      ...
      function: {
          ...
          description: "Strictly and immediately invoke this function when the caller indicates they want to end the call, such as saying 'bye' or when the intent is to terminate the call.",
          parameters: {
              type: 'object',
              properties: {
                  callSid: {
