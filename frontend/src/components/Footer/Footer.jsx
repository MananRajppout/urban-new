        ...
        <div className="flex flex-wrap justify-center items-center gap-4 md:gap-8 mb-8">
          {footerLinks.map((link) => (
            <Link
              key={link.label}
              href={link.href}
              className="no-underline font-medium text-foreground/70 hover:text-brand-green transition-colors text-sm md:text-base"
            >
              {link.label}
            </Link>
          ))}
          ...
          <div className="flex space-x-4 mt-4 md:mt-0">
            {socialLinks.map((social) => (
              <a
                key={social.name}
                href={social.href}
                className="text-foreground/60 hover:text-brand-green transition-colors"
