...
const PricingPlan = ({ activeService }) => {
  ...
  return (
    ...
    // >
    <div className="mx-2 mb-4 p-4 rounded-lg bg-glass-panel-light/20 border border-solid border-[rgba(255,255,255,0.1)] hover:bg-glass-panel-light/30 transition-colors">
